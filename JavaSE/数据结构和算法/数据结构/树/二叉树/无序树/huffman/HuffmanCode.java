package 数据结构和算法.数据结构.树.二叉树.huffman;
...
public class HuffmanCode {
    ...
    static     Map<Byte, String> hashMap;


    public static void main(String[] args) {
        byte []arr={0,1,2,4,5,6,9,10};
        byte[] zip = huffmanZip(arr);
        hashMap=huffmanCodes;

        System.out.println("压缩后="+Arrays.toString(zip));
        byte[] bytes = huffmanUnzip(hashMap, arr);
        System.out.println("压缩前="+Arrays.toString(arr));
